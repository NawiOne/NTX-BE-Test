...
const config = {
  ...
  // cacheDirectory: "C:\\Users\\it5ju\\AppData\\Local\\Temp\\jest",
  ...
  // globalSetup: '<rootDir>/tests/helper/global.setup.js',

  // A path to a module which exports an async function that is triggered once after all test suites
  // globalTeardown: '<rootDir>/tests/helper/global.teardown.js',
